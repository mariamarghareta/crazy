    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            <div class="col-md-8 col-md-offset-2 margin-up-md">
                ...
                if ($state == "update"){
                    echo form_open('Mastergelombang/update_data', $attributes);
                } else if ($state == "create"){
                    echo form_open('Mastergelombang/add_new_data', $attributes);
                } else if ($state == "delete"){
                    echo form_open('Mastergelombang/delete_data', $attributes);
                }
                ?>
                ...
                <div class="w3-container w3-white w3-padding-32">
                    <div style="margin:10px 20px;">
                        ...
                        <div class="row" style="margin-top: 25px;">
                            <div class="col-sm-12">
                                <label>Active</label>
                                <select name="active" class="col-sm-12 form-control">
                                    <option value="0" <?php if ($active == 0){echo "selected";}?> >Active</option>
                                    <option value="1" <?php if ($active == "" or $active == 1){echo "selected";}?> >Non Active</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if ($state == "update") { ?>
                        <div class="text-center">
                            ...
                            <button name="cancel" class="w3-button w3-grey w3-center margin-up-md"><a href="<?php echo base_url() . index_page(); ?>/Mastergelombang">Batal</a></button>
                        </div>

        ...
        <section class="wrapper site-min-height">
            <div class="col-md-12 white-bg margin-up-md">
                <div class="margin-down-lg ">
                    <div class="col-sm-8 page-title">Master Gelombang</div>
                    <div class="col-sm-4 right-align"><a href="<?php echo base_url() . index_page(); ?>/Mastergelombang/create" class="btn btn-success btn-sm"><i class="fa fa-plus"></i><span> TAMBAH DATA</span></a></div>
                </div>
                <table
                    id="table"
                    data-toggle="true"
                    ...
                    <tr>
                        ...
                        <th data-field="active" data-formatter="activeFormat" data-sortable="true">Aktif</th>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row) {
        return [
            '<a href="<?php echo base_url() . index_page(); ?>/Mastergelombang/Show/' + row['id'] + '" class="btn btn-default waves-effect">Lihat</a>',
            '<a href="<?php echo base_url() . index_page(); ?>/Mastergelombang/update/' + row['id'] + '" class="btn btn-default waves-effect">Ubah</a>',
            '<a href="<?php echo base_url() . index_page(); ?>/Mastergelombang/delete/' + row['id'] + '" class="btn btn-danger waves-effect">Hapus</a>',
        ].join('');
    }
